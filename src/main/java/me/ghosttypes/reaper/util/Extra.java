...
import me.ghosttypes.reaper.util.player.PlayerUtil;
...
public class Extra {
    ...
    public static BlockPos getCityBlock(PlayerEntity player) {
        ...
        posList.sort(Comparator.comparingDouble(PlayerUtil::distanceFromEye));
    ...
    public static boolean isBurrowed(PlayerEntity targetEntity, BlastResistantType type) {
        BlockPos playerPos = WorldUtils.roundBlockPos(new Vec3d(targetEntity.getX(), targetEntity.getY() + 0.4, targetEntity.getZ()));
