...
public class InvUtil {
    ...
    public static FindItemResult findButton() {
        return InvUtils.findInHotbar(itemStack -> Block.getBlockFromItem(itemStack.getItem()) instanceof AbstractPressurePlateBlock || Block.getBlockFromItem(itemStack.getItem()) instanceof AbstractButtonBlock);
    }
    ...
    public static String getItemNameBySlot(int slot) {
        return mc.player.getInventory().getStack(slot).getName().asString();
    }
