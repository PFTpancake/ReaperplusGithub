...
public class AutoEZ extends ReaperModule {
    ...
    public final Setting<Boolean> pmEz = sgGeneral.add(new BoolSetting.Builder().name("pm-ez").description("Send the AutoEz message to the player's dm.").defaultValue(true).build());
    public final Setting<Boolean> killStr = sgGeneral.add(new BoolSetting.Builder().name("killstreak").description("Add your killstreak to the end of AutoEz messages.").defaultValue(true).build());
    public final Setting<Boolean> suffix = sgGeneral.add(new BoolSetting.Builder().name("suffix").description("Add a suffix to the end of pop messages.").defaultValue(true).build());
    ...
    public void onActivate() {
        if (ezMessages.get().isEmpty()) {
            ...
            ezMessages.get().add("GG {player}, Reaper+ owns me and all   https://discord.gg/RprkhD4CC2");
            ezMessages.get().add("Damm {player}, Reaper+ just owned u https://discord.gg/RprkhD4CC2");
            ezMessages.get().add("{player} are you in vannila cause that was so easy thx to Reaper+ https://discord.gg/RprkhD4CC2");
            ezMessages.get().add("Good fight but can u try next time its to easy for Reaper+ https://discord.gg/RprkhD4CC2");
            ezMessages.get().add("OMG your so mad {player} pls get Reaper+ so you can win https://discord.gg/RprkhD4CC2");
        }
    }
