...
import me.ghosttypes.reaper.util.player.BlockHelper;
...
public class ReaperSurround extends ReaperModule {
    ...
    private final Setting<Integer> blockPerTick = sgGeneral.add(new IntSetting.Builder().name("blocks-per-tick").description("Block placements per tick.").defaultValue(4).min(1).sliderMax(20).build());
    ...
    public ReaperSurround() {
        super(ML.R, "Surround", "Best surround");
    }
